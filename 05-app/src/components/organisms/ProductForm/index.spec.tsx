...
describe('ProductForm', () => {
  ...
  it('폼 입력 후, onProductSave가 호출된다', async () => {
    ...
    await act(async () => {
      ...
      // 상품 제목을 입력
      const inputUsernameNode = screen.getByPlaceholderText(/상품 제목/) as HTMLInputElement
      fireEvent.change(inputUsernameNode, { target: { value: '상품' } })

      // 상품 정보를 입력
      const inputPasswordNode = screen.getByPlaceholderText(/ 최고의 상품입니다/) as HTMLInputElement
